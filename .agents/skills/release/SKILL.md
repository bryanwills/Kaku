...
- In-app updates (`kaku-gui/src/update.rs`, Kaku's own updater, not Sparkle) download `kaku_for_update.zip` and its `.sha256` from the latest GitHub Release.
